import 'package:face_detection_with_flutter/pages/album_page.dart';
import 'package:face_detection_with_flutter/pages/artist_list.dart';
import 'package:face_detection_with_flutter/pages/artist_page.dart';
                  ...
                  return InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => AlbumPage(index: index)),
                      );
                    },
                    child: Container(
                      // color: Colors.amber,
